...
public class Computer  extends Product{
    ...
    public Computer(String idProduct, int quantity, String marca, String processor, String motherBoard, String RAM, String SSD, int fans, String graphicCard, String cabinet) {
